      ...
      <section ref={contentRef} className="relative pb-24 lg:pb-32 overflow-hidden">
        <div className="relative max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          <div className="reveal glass-card p-8 sm:p-10 lg:p-12 space-y-8">
            ...
            <div>
              <h2 className="font-heading font-bold text-xl text-white mb-3">2. Services</h2>
              <p className="text-gray-400 font-body text-sm leading-relaxed">
            ...
            <div>
              <h2 className="font-heading font-bold text-xl text-white mb-3">3. Quotes and Proposals</h2>
              <p className="text-gray-400 font-body text-sm leading-relaxed">
            ...
            <div>
              <h2 className="font-heading font-bold text-xl text-white mb-3">4. Payment Terms</h2>
            ...
            <div>
              <h2 className="font-heading font-bold text-xl text-white mb-3">5. Client Responsibilities</h2>
            ...
            <div>
              <h2 className="font-heading font-bold text-xl text-white mb-3">6. Intellectual Property</h2>
              <ul className="space-y-2 text-gray-400 font-body text-sm leading-relaxed list-disc list-inside">
            ...
            <div>
              <h2 className="font-heading font-bold text-xl text-white mb-3">7. Revisions and Scope Changes</h2>
              <p className="text-gray-400 font-body text-sm leading-relaxed">
            ...
            <div>
              <h2 className="font-heading font-bold text-xl text-white mb-3">8. Website Management Plans</h2>
              <p className="text-gray-400 font-body text-sm leading-relaxed">
            ...
            <div>
              <h2 className="font-heading font-bold text-xl text-white mb-3">9. Limitation of Liability</h2>
              <ul className="space-y-2 text-gray-400 font-body text-sm leading-relaxed list-disc list-inside">
            ...
            <div>
              <h2 className="font-heading font-bold text-xl text-white mb-3">10. Cancellation and Refunds</h2>
              <ul className="space-y-2 text-gray-400 font-body text-sm leading-relaxed list-disc list-inside">
            ...
            <div>
              <h2 className="font-heading font-bold text-xl text-white mb-3">11. Confidentiality</h2>
              <p className="text-gray-400 font-body text-sm leading-relaxed">
            ...
            <div>
              <h2 className="font-heading font-bold text-xl text-white mb-3">12. Third-Party Services</h2>
              <p className="text-gray-400 font-body text-sm leading-relaxed">
            ...
            <div>
              <h2 className="font-heading font-bold text-xl text-white mb-3">13. Website Use</h2>
              <p className="text-gray-400 font-body text-sm leading-relaxed mb-3">
            ...
            <div>
              <h2 className="font-heading font-bold text-xl text-white mb-3">14. Governing Law</h2>
              <p className="text-gray-400 font-body text-sm leading-relaxed">
            ...
            <div>
              <h2 className="font-heading font-bold text-xl text-white mb-3">15. Changes to These Terms</h2>
              <p className="text-gray-400 font-body text-sm leading-relaxed">
            ...
            <div>
              <h2 className="font-heading font-bold text-xl text-white mb-3">16. Contact Us</h2>
              <p className="text-gray-400 font-body text-sm leading-relaxed">
